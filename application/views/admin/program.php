...
href="<?php echo base_url('admin/delete_program/'.$d->id_program);?>" 
> <i class="fa fa-trash"></i></a> <a class="btn  btn-primary btn-sm"  data-tooltip="tooltip"
  data-placement="top"
  title="Edit" href="javascript:;"
       data-toggle="modal" data-target="#edit"   
          data-id="<?= $d->id_program ?>"
          data-kode_program="<?= $d->kode_program ?>"
          data-nama_program="<?= $d->nama_program ?>"
...
echo form_open('admin/tambah_program'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('admin/update_program'); ?>

<!-- Modal body -->
<div class="modal-body">
  <input type="hidden" class="form-control"  name="id_program" id="id" required >
   <div class="mb-3">
...
modal.find('#kode_program').attr("value",div.data('kode_program'));
