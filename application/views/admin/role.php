...
echo form_open('admin/tambah_role'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('admin/update_role'); ?>

<!-- Modal body -->
<div class="modal-body">
<div class="mb-3">
<input type="hidden" class="form-control"  name="id_role" id="id" required >
    <label for="exampleInputEmail1">Nama Role</label>
...
modal.find('#nama_role').attr("value",div.data('nama_role'));
