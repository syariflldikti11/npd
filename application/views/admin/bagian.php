...
> <i class="fa fa-trash"></i></a> <a class="btn  btn-primary btn-sm"  data-tooltip="tooltip"
  ...
  title="Edit" href="javascript:;"
       data-toggle="modal" data-target="#edit"   
          data-id="<?= $d->id_bagian ?>"
          data-nama_bagian="<?= $d->nama_bagian ?>"
...
echo form_open('admin/tambah_bagian'); ?>
...
<!-- Modal Header -->
<div class="modal-header">
<h4 class="modal-title">Update Bagian</h4>
<button type="button" class="close" data-dismiss="modal">&times;</button>
</div>
<?php  
echo validation_errors();                       
...
<div class="modal-body">
<div class="mb-3">
<input type="hidden" class="form-control"  name="id_bagian" id="id" required >
    <label for="exampleInputEmail1">Nama Bagian</label>
...
modal.find('#nama_bagian').attr("value",div.data('nama_bagian'));
