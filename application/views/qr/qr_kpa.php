                ...
                echo validation_errors();
                     echo form_open('login/auth'); ?>
                        <fieldset>
                          ...
                          <div class="field">
                              <label class="label_field">Nama KPA</label>
                              <input type="text" name="username" value=" <?= $t->nama_pegawai ?>" readonly   />
                           </div>
                             <div class="field">
                              <label class="label_field">NIP</label>
                              <input type="text" name="username" value=" <?= $t->nip ?>" readonly   />
                           </div>
                           
                                    <div class="field">
                              <label class="label_field">Tanggal Persetujuan</label>
                          <input type="text" name="username" value=" <?= $y->tgl_persetujuan_kpa ?>" readonly   />
                           </div>
