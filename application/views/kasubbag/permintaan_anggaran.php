            ...
            <tr>
                <td><?= $no++; ?></td>
                 <td>
                       ...
                       <?php if($d->status_permintaan==2) :?><span class="badge badge-warning">Dikembalikan</span><?php endif; ?>
                       <?php if($d->status_permintaan==3) :?><span class="badge badge-danger">Di Tolak</span><?php endif; ?>
