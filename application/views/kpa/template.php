            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="<?= base_url('kpa');?>"><i class="fa fa-home red_color"></i> <span>Home</span></a></li>
                      <!--  <li><a href="<?= base_url('kpa/role');?>"><i class="fa fa-briefcase orange_color"></i> <span>Role</span></a></li> -->
                        
                      
                      
                         <li><a href="<?= base_url('kpa/npd');?>"><i class="fa fa-file orange_color"></i> <span>NPD</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="element">
                          ...
                          <li><a href="<?= base_url('kpa/laporan_program_kegiatan_sub');?>">> <span>Program/Kegiatan/Sub</span></a></li>
                          <li><a href="<?= base_url('kpa/laporan_rekening');?>">> <span>Kode Rekening</span></a></li>
...
echo form_open('kpa/ganti_password'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('kpa/laporan_permintaan_anggaran'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('kpa/laporan_npd'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('kpa/laporan_rincian_npd'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('kpa/laporan_pencairan_program'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('kpa/laporan_pencairan_bagian'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('kpa/laporan_pencairan_rekening'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('kpa/laporan_pencairan_kegiatan'); ?>
