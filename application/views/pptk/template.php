               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="<?= base_url('pptk');?>"><i class="fa fa-home red_color"></i> <span>Home</span></a></li>
                      ...
                      <li><a href="<?= base_url('pptk/permintaan_anggaran');?>"><i class="fa fa-file blue1_color"></i> <span>Permintaan Anggaran</span></a></li>
                        ...
                        <ul class="collapse list-unstyled" id="element">
                          ...
                          <li><a href="<?= base_url('pptk/laporan_program_kegiatan_sub');?>">> <span>Program/Kegiatan/Sub</span></a></li>
                          <li><a href="<?= base_url('pptk/laporan_rekening');?>">> <span>Kode Rekening</span></a></li>
...
<?php  
echo validation_errors();                       
echo form_open('pptk/laporan_permintaan_anggaran'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('pptk/laporan_npd'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('pptk/laporan_rincian_npd'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('pptk/laporan_pencairan_program'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('pptk/laporan_pencairan_bagian'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('pptk/laporan_pencairan_rekening'); ?>
...
<?php  
echo validation_errors();                       
echo form_open('pptk/laporan_pencairan_kegiatan'); ?>
