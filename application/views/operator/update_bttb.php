         ...
         <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Update BTTB Pelanggan Tetap</h4>
                    <?php                        
    echo form_open('operator/update_bttb','class="form-sample"'); ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               ...
                               <input type="hidden" class="form-control" name="old_id_pelanggan" value="<?= $d->id_pelanggan; ?>"> 
                               <input type="hidden" class="form-control" name="old_kota_tujuan" value="<?= $d->kota_tujuan; ?>"> 
                               <input type="hidden" class="form-control" name="id_bttb" value="<?= $d->id_bttb; ?>"> 
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <select class="js-example-basic-single form-select" style="width:100%" id="category" name="id_pelanggan">
                  ...
                  <?php endforeach; ?>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="number" class="form-control" name="biaya_paket" value="<?= $d->biaya_paket; ?>" required readonly />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                               <select class="js-example-basic-single form-select" id="sub_category" name="kota_tujuan" >
